...
export default function OrphanageData() {
  ...
  async function handleSelectImages() {
    ...
    const result = await ImagePicker.launchImageLibraryAsync({
      allowsEditing: true,
      quality: 1,
      mediaTypes: ImagePicker.MediaTypeOptions.Images, // dizendo que só quero imagens e não videos
    });
    ...
    setImages([...images, uri]); //copia todas as imagens que ja tem e adiciona a uri no final
    ...
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 24 }}>
      ...
      <View style={styles.switchContainer}>
        ...
        <Switch
          ...
          onValueChange={(toggle) => setOpenOnWeekends(toggle)}
        />
      </View>
